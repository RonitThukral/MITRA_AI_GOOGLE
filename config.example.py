...
# Credentials
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "path/to/your/service.json"  # Replace with your service account JSON path
os.environ['GOOGLE_API_KEY'] = "your-google-api-key-here"  # Replace with your Google API key

# Project details
PROJECT_ID = "your-project-id-here"  # Replace with your Google Cloud project ID
LOCATION = "your-location-here"  # Replace with your Google Cloud location (e.g., us-central1)
MODEL_NAME = os.environ.get("MODEL_NAME", "gemini-2.0-flash-001")  # Default model name
LIVE_MODEL = "gemini-2.0-flash-exp"  # Default live model name
...
SYSTEM_PROMPTS = {
    ...
    "career_suggest": (
        "SYSTEM: You are Mitra, an expert career counselor for the Indian education system. "
